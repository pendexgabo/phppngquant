...
zend_class_entry *pngquant_exception_pngquantexception_ce;
zend_class_entry *pngquant_exception_binarynotfoundexception_ce;
zend_class_entry *pngquant_exception_ioerrorexception_ce;
zend_class_entry *pngquant_pngquant_ce;

ZEND_DECLARE_MODULE_GLOBALS(pngquant)
...
static PHP_MINIT_FUNCTION(pngquant)
{
#if PHP_VERSION_ID < 50500
	...
	ZEPHIR_INIT(Pngquant_Exception_PngquantException);
	ZEPHIR_INIT(Pngquant_Exception_BinaryNotFoundException);
	ZEPHIR_INIT(Pngquant_Exception_IOErrorException);
	ZEPHIR_INIT(Pngquant_Pngquant);
...
#ifndef ZEPHIR_RELEASE
static PHP_MSHUTDOWN_FUNCTION(pngquant)
{
 ...
 */
static void php_zephir_init_globals(zend_pngquant_globals *zephir_globals TSRMLS_DC)
{
...
static PHP_RINIT_FUNCTION(pngquant)
{

	zend_pngquant_globals *zephir_globals_ptr = ZEPHIR_VGLOBAL;
...
static PHP_RSHUTDOWN_FUNCTION(pngquant)
{
...
static PHP_MINFO_FUNCTION(pngquant)
{
	php_info_print_box_start(0);
	php_printf("%s", PHP_PNGQUANT_DESCRIPTION);
	php_info_print_box_end();

	php_info_print_table_start();
	php_info_print_table_header(2, PHP_PNGQUANT_NAME, "enabled");
	php_info_print_table_row(2, "Author", PHP_PNGQUANT_AUTHOR);
	php_info_print_table_row(2, "Version", PHP_PNGQUANT_VERSION);
	php_info_print_table_row(2, "Powered by Zephir", "Version " PHP_PNGQUANT_ZEPVERSION);
	php_info_print_table_end();


}

static PHP_GINIT_FUNCTION(pngquant)
{
	php_zephir_init_globals(pngquant_globals TSRMLS_CC);
}

static PHP_GSHUTDOWN_FUNCTION(pngquant)
{

}

zend_module_entry pngquant_module_entry = {
	STANDARD_MODULE_HEADER_EX,
	NULL,
	NULL,
	PHP_PNGQUANT_EXTNAME,
	NULL,
	PHP_MINIT(pngquant),
#ifndef ZEPHIR_RELEASE
	PHP_MSHUTDOWN(pngquant),
#else
	NULL,
#endif
	PHP_RINIT(pngquant),
	PHP_RSHUTDOWN(pngquant),
	PHP_MINFO(pngquant),
	PHP_PNGQUANT_VERSION,
	ZEND_MODULE_GLOBALS(pngquant),
	PHP_GINIT(pngquant),
	PHP_GSHUTDOWN(pngquant),
	NULL,
	STANDARD_MODULE_PROPERTIES_EX
};

#ifdef COMPILE_DL_PNGQUANT
ZEND_GET_MODULE(pngquant)
#endif
